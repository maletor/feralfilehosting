...
then
    ...
    echo
    echo -e \"\\\033[33m2:\\\e[0m These are the URLs and ports Subsonic is configured to use:\"
    echo
    if [[ -d ~/.nginx/conf.d/000-default-server.d ]]
    then
        echo -e \"\\\033[31mSubsonic\\\e[0m last accessible at \\\033[31mhttps://\$(hostname)\$contextpath\\\e[0m\"
    else
